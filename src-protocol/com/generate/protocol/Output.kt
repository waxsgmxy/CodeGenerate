...
fun getImports(protocol: Protocol): List<String> {
    val list = mutableListOf("import com.evergrande.rooban.net.base.api.IHDRequestListener;"
            , "import com.evergrande.rooban.net.annotation.HDAnnotationMtpResponse;"
            , "import com.evergrande.rooban.net.annotation.Protocol;"
            , "import org.json.JSONObject;"
            , "import java.util.ArrayList;");
    when (protocol.type) {
        ProtocolType.TYPE_MTP -> list.add("import com.evergrande.rooban.net.annotation.HDAnnotationMtpProtocol;")
        ProtocolType.TYPE_YM -> list.add("import com.evergrande.rooban.net.annotation.HDAnnotationYMProtocol;")
    }
    if (useSimpleValue) {
        list.add("import com.evergrande.rooban.net.annotation.SimpleValue;");
    }
    return list;
}
...
//        append("import com.evergrande.eif.net.api.base.annotation.HDAnnotationMtpProtocol;\n")
...
//        append("import java.util.ArrayList;${line(2)}")
        for (str in getImports(protocol)) {
            append("$str\n")
        }
        append("\n")
        note("generated by CodeGenerate...");
        append("public class ${protocol.className} extends ${getProtocolClass()} {${line(2)}")
    }

    fun getProtocolClass(): String {
        if (protocol.type == ProtocolType.TYPE_YM) {
            return "HDAnnotationYMProtocol";
        }
        return "HDAnnotationMtpProtocol";
    }
